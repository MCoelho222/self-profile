...
export default function Home() {
  ...
  return (
    <main className="flex flex-col justify-center min-h-screen bg-slate-900 p-4 mx-5 sm:flex-row">
      <div className=" w-full h-full flex flex-col items-center sm:w-1/5 sm:fixed sm:top-0 sm:left-0 sm:pt-10 sm:p-10 sm:bg-slate-800">
        <Image
      ...
      <div className="w-full pt-8 sm:w-3/4 sm:pl-[12%]">
