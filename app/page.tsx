...
export default function Home() {
  ...
  return (
    <main className="flex flex-col justify-center min-h-screen bg-slate-200 p-5 sm:flex-row">
      <div className="w-full h-full flex flex-col items-center sm:w-1/5 sm:fixed sm:top-0 sm:left-0 sm:pt-9 sm:px-7 sm:bg-slate-300">
        <Image
        ...
        <div className="flex flex-row justify-center pt-3">
          <p className="dark-text sm:text-base text-justify">{cvData.welcome}</p>
        </div>
      </div>
